...
// One other way to share values with a component is to pass them in as a prop.
// <CounterContext.Provider value={{count, handleIncrement, handleDecrement}}>
// {children}
// </CounterContext.Provider>

export {Provider} // exporting the provider component so we can use it in the app.js file
export default CounterContext
